...
ax.plot(beta_phi[star_idx], smooth_chi[star_idx], 'bD', markersize=15, zorder=3)
ax.plot(beta_phi[minus_idx], smooth_chi[minus_idx], 'b<', markersize=15, zorder=3)
ax.plot(beta_phi[plus_idx], smooth_chi[plus_idx], 'b>', markersize=15, zorder=3)
ax.plot(beta_phi[opt_idx_prime], smooth_chi[opt_idx_prime], 'gP', markersize=25, zorder=3)
ax.plot(beta_phi[opt_idx], smooth_chi[opt_idx], 'rX', markersize=25, zorder=3)
...
ax.plot(np.delete(fpr, [minus_idx, plus_idx, opt_idx, opt_idx_prime, star_idx]), np.delete(tpr, [minus_idx, plus_idx, opt_idx, opt_idx_prime, star_idx]), 'o', color='gray', markersize=12)
l = ax.plot(fpr[star_idx], tpr[star_idx], 'bD', markersize=20, label=r'$\phi^*$')
l[0].set_clip_on(False)
l = ax.plot(fpr[minus_idx], tpr[minus_idx], 'b<', markersize=30, label=r'$\phi^{(-)}$')
l[0].set_clip_on(False)
ax.plot(fpr[plus_idx], tpr[plus_idx], 'b>', markersize=30, label=r'$\phi^{(+)}$')
ax.plot(fpr[opt_idx_prime], tpr[opt_idx_prime], 'gP', markersize=40, label=r"$\phi^\mathrm{opt'}$")
ax.plot(fpr[opt_idx], tpr[opt_idx], 'rX', markersize=40, label=r'$\phi^\mathrm{opt}$')
...
ax.plot(beta_phi[opt_idx_prime], tpr[opt_idx_prime], 'gP', markersize=30)
ax.plot(beta_phi[opt_idx], tpr[opt_idx], 'rX', markersize=30)
l = ax.plot(beta_phi[minus_idx], tpr[minus_idx], 'b<', markersize=20)
l[0].set_clip_on(False)
ax.plot(beta_phi[plus_idx], tpr[plus_idx], 'b>', markersize=20)

ax.plot(beta_phi, fpr, '-', color=c2, linewidth=4, label='FPR')
l = ax.plot(beta_phi[star_idx], fpr[star_idx], 'bD', markersize=18)
l[0].set_clip_on(False)
ax.plot(beta_phi[opt_idx_prime], fpr[opt_idx_prime], 'gP', markersize=30)
ax.plot(beta_phi[opt_idx], fpr[opt_idx], 'rX', markersize=30)
l = ax.plot(beta_phi[minus_idx], fpr[minus_idx], 'b<', markersize=20)
l[0].set_clip_on(False)
ax.plot(beta_phi[plus_idx], fpr[plus_idx], 'b>', markersize=20)

#ax.plot(beta_phi, ppv, '-', color=c3, linewidth=4, label='PPV')
#ax.plot(beta_phi[star_idx], ppv[star_idx], 'bD', markersize=18)
#ax.plot(beta_phi[opt_idx_prime], ppv[opt_idx_prime], 'gP', markersize=30)
#ax.plot(beta_phi[opt_idx], ppv[opt_idx], 'rX', markersize=30)
#l = ax.plot(beta_phi[minus_idx], ppv[minus_idx], 'b<', markersize=20)
#l[0].set_clip_on(False)
#ax.plot(beta_phi[plus_idx], ppv[plus_idx], 'b>', markersize=20)
...
#fig.savefig('{}/Desktop/legend.pdf'.format(homedir), transparent=True)
plt.close('all')
###############################################
...
ax.plot(beta_phi[opt_idx], f_h[opt_idx], 'rX', markersize=30)
...
ax.plot(beta_phi[opt_idx_prime], f_1[opt_idx_prime], 'gP', markersize=30)
