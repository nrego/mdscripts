...
ax.plot(beta_phi[star_idx], smooth_chi[star_idx], 'bD', markersize=20, zorder=3)
ax.plot(beta_phi[minus_idx], smooth_chi[minus_idx], 'b<', markersize=25, zorder=3)
ax.plot(beta_phi[plus_idx], smooth_chi[plus_idx], 'b>', markersize=25, zorder=3)
ax.plot(beta_phi[opt_idx_prime], smooth_chi[opt_idx_prime], 'gP', markersize=35, zorder=3)
ax.plot(beta_phi[opt_idx], smooth_chi[opt_idx], 'rX', markersize=35, zorder=3)
...
l = ax.plot(fpr[star_idx], tpr[star_idx], 'bD', markersize=30, label=r'$\phi^*$')
l[0].set_clip_on(False)
l = ax.plot(fpr[minus_idx], tpr[minus_idx], 'b<', markersize=40, label=r'$\phi^{(-)}$')
l[0].set_clip_on(False)
ax.plot(fpr[plus_idx], tpr[plus_idx], 'b>', markersize=40, label=r'$\phi^{(+)}$')
ax.plot(fpr[opt_idx_prime], tpr[opt_idx_prime], 'gP', markersize=50, label=r"$\phi^\mathrm{opt'}$")
ax.plot(fpr[opt_idx], tpr[opt_idx], 'rX', markersize=50, label=r'$\phi^\mathrm{opt}$')
