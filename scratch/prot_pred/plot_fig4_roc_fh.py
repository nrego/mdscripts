...
ax.plot(fpr[best_idx], tpr[best_idx], 'rX', markersize=25, label=r'$\phi_\mathrm{opt}$')
...
ax.plot(beta*phi[star_idx], f_h[star_idx], 'bD', markersize=20)
ax.plot(beta*phi[best_idx], f_h[best_idx], 'rX', markersize=25)
ax.plot(beta*phi[minus_idx], f_h[minus_idx], 'b<', markersize=20)
ax.plot(beta*phi[plus_idx], f_h[plus_idx], 'b>', markersize=20)
