...
l = ax.plot(fpr[star_idx], tpr[star_idx], 'bD', markersize=35, label=r'$\phi^*$')
l[0].set_clip_on(False)
l = ax.plot(fpr[minus_idx], tpr[minus_idx], 'b<', markersize=40, label=r'$\phi_{-}$')
l[0].set_clip_on(False)
ax.plot(fpr[plus_idx], tpr[plus_idx], 'b>', markersize=40, label=r'$\phi_{+}$')
ax.plot(fpr[best_idx], tpr[best_idx], 'rX', markersize=50, label=r'$\phi_\mathrm{opt}$')
...
l = ax.plot(beta_phi[star_idx], f_h[star_idx], 'bD', markersize=20)
l[0].set_clip_on(False)
l = ax.plot(beta_phi[best_idx], f_h[best_idx], 'rX', markersize=30)
l[0].set_clip_on(False)
l = ax.plot(beta_phi[minus_idx], f_h[minus_idx], 'b<', markersize=25)
l[0].set_clip_on(False)
l = ax.plot(beta_phi[plus_idx], f_h[plus_idx], 'b>', markersize=25)
l[0].set_clip_on(False)
...
ax.plot(beta_phi[star_idx], tpr[star_idx], 'bD', markersize=30)
ax.plot(beta_phi[best_idx], tpr[best_idx], 'rX', markersize=40)
ax.plot(beta_phi[minus_idx], tpr[minus_idx], 'b<', markersize=35)
ax.plot(beta_phi[plus_idx], tpr[plus_idx], 'b>', markersize=35)
...
ax.plot(beta_phi[star_idx], fpr[star_idx], 'bD', markersize=30)
ax.plot(beta_phi[best_idx], fpr[best_idx], 'rX', markersize=40)
ax.plot(beta_phi[minus_idx], fpr[minus_idx], 'b<', markersize=35)
ax.plot(beta_phi[plus_idx], fpr[plus_idx], 'b>', markersize=35)
