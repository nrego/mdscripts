...
for sys_name in sys_names:
    ...
    backbone_rmsds.append(dat[1])
    heavy_rmsds.append(dat[2])

indices = np.arange(len(sys_names))

width=0.4
ax.bar(indices-width, backbone_rmsds, width=width, align='edge')
ax.bar(indices, heavy_rmsds, width, align='edge')
